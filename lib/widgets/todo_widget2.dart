...
class TodoWidget2 extends StatefulWidget {
  final String title;
  final int id;
  final bool isCompleted;

  const TodoWidget2({Key key, this.title, this.id, this.isCompleted})
      : super(key: key);

  @override
  _TodoWidget2State createState() => _TodoWidget2State();
}

class _TodoWidget2State extends State<TodoWidget2>
